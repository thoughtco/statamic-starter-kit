...
```php please starter-kit:install thoughtco/statamic-starter-kit```  
...
- Full output information is available [here](https://packagist.org/packages/thoughtco/statamic-cookiepanel)
...
- Full documentation is available [here](https://packagist.org/packages/thoughtco/statamic-postmark-spamcheck)
...
- Read the documentation at [here](https://statamic.com/addons/statamic/seo-pro/docs)
...
- Any redirects should be added to the redirects area here.
...
- `GOOGLE_MAPS_GEOCODING_API_KEY`: the api key to be used across the site to display the map. 
- `GOOGLE_MAP_ID`: the id of the map from the Google Cloud Console.

A video of how to obtain both the key and the id can be found [here](https://www.loom.com/share/5f027f88b67e4411bbce62c3ab934d15).
...
An API key and a Map ID are required which you can do [here](https://github.com/thoughtco/statamic-starter-kit?tab=readme-ov-file#env-variables)
